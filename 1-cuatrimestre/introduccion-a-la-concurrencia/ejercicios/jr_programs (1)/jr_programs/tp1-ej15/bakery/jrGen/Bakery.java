...
public class Bakery extends java.lang.Object {
    { JRinit(); }
    ...
    private static int maximo(int[] arr) {
        int max = arr[0];
        JRLoop0: for (int i = 1; i < turnLenght; i++) {
            if (arr[i] > max) {
                // Begin Expr2
                max = arr[i];
            }
    ...
    {
        public ProcOp_voidTovoid_implp0(Bakery thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Bakery.p0voidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Bakery.p0voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void p0voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop4: for (int s = 0; s <= S; s++) {
                    JRLoop3: do {
                        // Begin Expr2
                        turn[0] = 1;
                        // Begin Expr2
                        turn[0] = maximo(turn) + 1;
                        JRLoop2: for (int j = 1; j <= turnLenght - 1; j++) {
                            JRLoop1: while ((turn[j] != 0) && (turn[0] < turn[j])) {
                            }
                            ;
                        }
                        // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_implp1(Bakery thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Bakery.p1voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Bakery.p1voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
        ...
        try    {
            {
                JRLoop8: for (int s = 0; s <= S; s++) {
                    JRLoop7: do {
                        ...
                        JRLoop6: for (int j = 1; j <= turnLenght - 1; j++) {
                            JRLoop5: while (turn[j] != 0 && turn[1] < turn[j]) {
                            }
                            ;
                        }
                        // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_impldone(Bakery thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Bakery.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Bakery.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRBakery jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRBakery(op_done_voidTovoid, op_p1_voidTovoid, op_p0_voidTovoid);
    	this.JRcalled = true;
    }
