...
public class SpinLockTs extends java.lang.Object {
    { JRinit(); }
    ...
    {
        public ProcOp_voidTovoid_implprocess1(SpinLockTs thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                SpinLockTs.process1voidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    SpinLockTs.process1voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
        ...
        try    {
            {
                JRLoop2: for (int s = 0; s <= S; s++) {
                    JRLoop1: while (true) {
                        JRLoop0: while (testSet(lock)) {
                            // Begin Expr2
                            System.out.println("El proceso 1 estuvo en livelock");
                        }
                        // Begin Expr2
                        x = x + 1;
                        // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_implprocess2(SpinLockTs thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                SpinLockTs.process2voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    SpinLockTs.process2voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
        ...
        try    {
            {
                JRLoop5: for (int s = 0; s <= S; s++) {
                    JRLoop4: while (true) {
                        JRLoop3: while (testSet(lock)) {
                            // Begin Expr2
                            System.out.println("El proceso 2 estuvo en livelock");
                        }
                        // Begin Expr2
                        x = x + 2;
                        // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_impldone(SpinLockTs thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                SpinLockTs.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    SpinLockTs.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRSpinLockTs jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRSpinLockTs(op_done_voidTovoid, op_process2_voidTovoid, op_process1_voidTovoid);
    	this.JRcalled = true;
    }
