...
import java.io.Serializable;
	...
	this.op_p0_voidTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[3]);

	}
	public JRTicket(boolean dummy)	{
	    super(dummy);
