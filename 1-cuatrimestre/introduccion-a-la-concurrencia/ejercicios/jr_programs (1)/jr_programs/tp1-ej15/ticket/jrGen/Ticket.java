...
public class Ticket extends java.lang.Object {
    ...
    private static Op_ext.JRProxyOp JRget_op_p0_voidTovoid()
    {
        return op_p0_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_p0_voidTovoid;
    static class ProcOp_voidTovoid_implp0 extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implp0(Ticket thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Ticket.p0voidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Ticket.p0voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_p0_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implp0(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void p0voidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_p0_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void p0voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop2: for (int s = 0; s <= S; s++) {
                    JRLoop1: do {
                        // Begin Expr2
                        turn[0] = number;
                        // Begin Expr2
                        number = +1;
                        JRLoop0: while (turn[0] != next) {
                        }
                        ;
                        // Begin Expr2
                        x = x + 1;
    ...
    static {
        try {
            op_p0_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
    ...
    {
        public ProcOp_voidTovoid_implp1(Ticket thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Ticket.p1voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Ticket.p1voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void p1voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop5: for (int s = 0; s <= S; s++) {
                    JRLoop4: do {
                        // Begin Expr2
                        turn[1] = number;
                        // Begin Expr2
                        number = +1;
                        JRLoop3: while (turn[1] != next) {
                        }
                        ;
                        // Begin Expr2
                        x = x + 1;
    ...
    {
        public ProcOp_voidTovoid_implp2(Ticket thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Ticket.p2voidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Ticket.p2voidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void p2voidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop8: for (int s = 0; s <= S; s++) {
                    JRLoop7: do {
                        // Begin Expr2
                        turn[2] = number;
                        // Begin Expr2
                        number = +1;
                        JRLoop6: while (turn[2] != next) {
                        }
                        ;
                        // Begin Expr2
                        x = x + 1;
    ...
    {
        public ProcOp_voidTovoid_impldone(Ticket thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Ticket.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Ticket.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRTicket jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRTicket(op_done_voidTovoid, op_p2_voidTovoid, op_p1_voidTovoid, op_p0_voidTovoid);
    	this.JRcalled = true;
    }
