...
public class FetchArr extends java.lang.Object {
    { JRinit(); }
    ...
    private static int[] arr = {500, 2, 5600, 1000, 9, 200, 12, 15, 1, 9, 201, 60000};
    private static int maxImpar;
    private static int maxPar;
    private static int arrLenght = 12;
    private static Op_ext.JRProxyOp JRget_op_impar_voidTovoid()
    {
    ...
    {
        public ProcOp_voidTovoid_implimpar(FetchArr thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                FetchArr.imparvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    FetchArr.imparvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void imparvoidTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            {
                // Begin Expr2
                maxImpar = arr[1];
                JRLoop0: for (int i = 1; i <= arrLenght - 1; i += 2) {
                    if (arr[i] > maxImpar) {
                        // Begin Expr2
                        maxImpar = arr[i];
                    }
    ...
    private static Op_ext.JRProxyOp JRget_op_par_voidTovoid()
    {
    ...
    {
        public ProcOp_voidTovoid_implpar(FetchArr thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                FetchArr.parvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    FetchArr.parvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void parvoidTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            {
                // Begin Expr2
                maxPar = arr[0];
                JRLoop1: for (int i = 0; i <= arrLenght - 1; i += 2) {
                    if (arr[i] > maxPar) {
                        // Begin Expr2
                        maxPar = arr[i];
                    }
    ...
    private static void donevoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                // Begin Expr2
                System.out.println("maxImpar = " + maxImpar + " maxPar = " + maxPar);
                if (maxImpar > maxPar) {
                    // Begin Expr2
                    System.out.println("El mayor es: " + maxImpar);
                } else if (maxPar > maxImpar) {
                    // Begin Expr2
                    System.out.println("El mayor es: " + maxPar);
                } else {
                    // Begin Expr2
                    System.out.println("El mayor es: " + maxImpar);
                }
    ...
    {
        public ProcOp_voidTovoid_impldone(FetchArr thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                FetchArr.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    FetchArr.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRFetchArr jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRFetchArr(op_done_voidTovoid, op_par_voidTovoid, op_impar_voidTovoid);
    	this.JRcalled = true;
    }
