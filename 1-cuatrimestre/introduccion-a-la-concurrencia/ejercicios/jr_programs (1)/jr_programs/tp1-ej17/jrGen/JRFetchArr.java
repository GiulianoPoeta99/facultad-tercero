...
import java.io.Serializable;
	...
	public JRFetchArr(JRFetchArr copy)
	{
	...
	public JRFetchArr(Object ... opSig)
	{
	this.op_done_voidTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[0]);
	this.op_par_voidTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[1]);
	this.op_impar_voidTovoid = new Cap_ext_((Op_ext_.JRProxyOp)opSig[2]);

	}
	public JRFetchArr(boolean dummy)	{
	    super(dummy);
