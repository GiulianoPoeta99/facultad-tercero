...
public class ProductConsum extends java.lang.Object {
    { JRinit(); }
    
    public ProductConsum() {
        // Begin Expr2
        super();
        JRprocess();
    }
    private static int cantidadProductos = 40;
    ...
    {
        public ProcOp_voidTovoid_implproductor(ProductConsum thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                ProductConsum.productorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductConsum.productorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void productorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop1: for (int i = 1; i <= cantidadProductos; i++) {
    ...
    private static Op_ext.JRProxyOp JRget_op_consumir_voidTovoid()
    {
        return op_consumir_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_consumir_voidTovoid;
    static class ProcOp_voidTovoid_implconsumir extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implconsumir(ProductConsum thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProductConsum.consumirvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductConsum.consumirvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_consumir_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implconsumir(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void consumirvoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_consumir_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void consumirvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop2: while (!terminar && cola.vacia()) {
                }
                ;
                JRLoop5: while (!terminar || !cola.vacia() || (terminar && !cola.vacia()) || (cola.vacia() && !terminar)) {
                    JRLoop3: while (!terminar && cola.vacia()) {
                    }
                    ;
                    JRLoop4: while (!cola.vacia()) {
                        // Begin Expr2
                        suma = suma + cola.pop();
                        // Begin Expr2
    ...
    static {
        try {
            op_consumir_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    {
        public ProcOp_voidTovoid_impldone(ProductConsum thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProductConsum.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductConsum.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRProductConsum jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRProductConsum(op_done_voidTovoid, op_consumir_voidTovoid, op_productor_voidTovoid);
    	this.JRcalled = true;
    }
