...
public class Barberia extends java.lang.Object {
    ...
    private static Op_ext.JRProxyOp JRget_op_clientes_voidTovoid()
    {
        return op_clientes_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_clientes_voidTovoid;
    ;
    static    {
        try    {
            op_clientes_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_clientes_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
    ...
    static    {
        try    {
            op_barbero_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
    ...
    private static Op_ext.JRProxyOp JRget_op_cobrar_voidTovoid()
    {
    ...
    private static Op_ext.JRProxyOp JRget_op_barber_voidTovoid()
    {
        return op_barber_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_barber_voidTovoid;
    static class ProcOp_voidTovoid_implbarber extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implbarber(Barberia thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Barberia.barbervoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Barberia.barbervoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_barber_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implbarber(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void barbervoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_barber_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void barbervoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop0: while (true) {
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_barbero_voidTovoid().recv();
                    ...
                    if (clientes_esperando.longitud() == N) {
                        ...
                        JRget_op_clientes_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                        // Begin Expr2
    ...
    static {
        try {
            op_barber_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    
    private static Op_ext.JRProxyOp JRget_op_customer_intTovoid()
    {
        return op_customer_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_customer_intTovoid;
    static class ProcOp_intTovoid_implcustomer extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implcustomer(Barberia thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Barberia.customerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Barberia.customerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_customer_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implcustomer(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void customerintTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_customer_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void customerintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
            int i = ((Number) JRargs[0]).intValue();
            {
                ...
                if (clientes_esperando.longitud() < 3) {
                    ...
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    JRget_op_barbero_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_clientes_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
    ...
    static {
        try {
            for (int i = 0; i < M; i++) {
                op_customer_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    {
        public ProcOp_voidTovoid_impldone(Barberia thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Barberia.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Barberia.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRBarberia(op_done_voidTovoid, op_customer_intTovoid, op_barber_voidTovoid, op_cobrar_voidTovoid, op_mutex_voidTovoid, op_barbero_voidTovoid, op_clientes_voidTovoid);
    	this.JRcalled = true;
    }
