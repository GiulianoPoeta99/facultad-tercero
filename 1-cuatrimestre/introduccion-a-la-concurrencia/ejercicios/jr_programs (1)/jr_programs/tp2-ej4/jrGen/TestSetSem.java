...
public class TestSetSem extends java.lang.Object {
    { JRinit(); }
    ...
    private static Op_ext.JRProxyOp JRget_op_p1_intTovoid()
    {
        return op_p1_intTovoid;
    }
    
    public static Op_ext.JRProxyOp op_p1_intTovoid;
    static class ProcOp_intTovoid_implp1 extends ProcOp_ext_impl
    {
        public ProcOp_intTovoid_implp1(TestSetSem thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                TestSetSem.p1intTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    TestSetSem.p1intTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    static    {
        try    {
            op_p1_intTovoid = new Op_ext_.JRProxyOp(new ProcOp_intTovoid_implp1(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void p1intTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_p1_intTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void p1intTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            // GetMethod 1
    ...
    static {
        try {
            for (int i = 0; i < N; i++) {
                op_p1_intTovoid.send(jrvm.getTimestamp(), new java.lang.Object [] {i});
            }
    ...
    {
        public ProcOp_voidTovoid_impldone(TestSetSem thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                TestSetSem.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    TestSetSem.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRTestSetSem jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRTestSetSem(op_done_voidTovoid, op_p1_intTovoid, op_mutex_voidTovoid);
    	this.JRcalled = true;
    }
