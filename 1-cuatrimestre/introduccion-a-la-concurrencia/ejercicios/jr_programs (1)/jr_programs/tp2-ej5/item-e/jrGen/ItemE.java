...
public class ItemE extends java.lang.Object {
    { JRinit(); }
    ...
    private static Op_ext.JRProxyOp JRget_op_mutexProd_voidTovoid()
    {
        return op_mutexProd_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexProd_voidTovoid;
    ;
    static    {
        try    {
            op_mutexProd_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexProd_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static Op_ext.JRProxyOp JRget_op_mutexConsum_voidTovoid()
    {
        return op_mutexConsum_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexConsum_voidTovoid;
    ;
    static    {
        try    {
            op_mutexConsum_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexConsum_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    private static Op_ext.JRProxyOp JRget_op_producer_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implproducer(ItemE thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                ItemE.producerintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ItemE.producerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void producerintTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop0: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexProd_voidTovoid().recv();
                    ...
                    JRget_op_mutexProd_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
            }
        } catch (Exception JRe)    {
    ...
    private static Op_ext.JRProxyOp JRget_op_consumer_intTovoid()
    {
    ...
    {
        public ProcOp_intTovoid_implconsumer(ItemE thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ItemE.consumerintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ItemE.consumerintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void consumerintTovoid(java.lang.Object [] JRargs) {
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexConsum_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    JRget_op_mutexConsum_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    {
        public ProcOp_voidTovoid_impldone(ItemE thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ItemE.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ItemE.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRItemE jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRItemE(op_done_voidTovoid, op_consumer_intTovoid, op_producer_intTovoid, op_mutexConsum_voidTovoid, op_mutexProd_voidTovoid, op_full_voidTovoid, op_empty_voidTovoid);
    	this.JRcalled = true;
    }
