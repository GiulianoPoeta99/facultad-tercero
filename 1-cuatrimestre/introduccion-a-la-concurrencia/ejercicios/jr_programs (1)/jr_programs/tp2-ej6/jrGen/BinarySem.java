...
public class BinarySem extends java.lang.Object {
    { JRinit(); }
    ...
    Cap_ext_[] mutex = new // NUMBER 8
    Cap_ext_[N];
    static {
        // Begin Expr2
        mutex[0] = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create((1))));
        JRLoop0: for (int i = 1; i < N; i++) {
            // Begin Expr2
            mutex[i] = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create()));
        }
    }
    ...
    {
        public ProcOp_intTovoid_implp(BinarySem thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                BinarySem.pintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    BinarySem.pintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void pintTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            ...
            {
                JRLoop1: for (int cycle = 1; cycle <= C; cycle++) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = mutex[5].recv();
                    ...
                    mutex[(i + 1) % N].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
                // Return
                { if (retOp != null)
    ...
    {
        public ProcOp_voidTovoid_impldone(BinarySem thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                BinarySem.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    BinarySem.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRBinarySem jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRBinarySem(op_done_voidTovoid, op_p_intTovoid);
    	this.JRcalled = true;
    }
