...
public class PrioridadEscritor extends java.lang.Object {
    { JRinit(); }
    
    public PrioridadEscritor() {
        // Begin Expr2
        super();
        JRprocess();
    }
    private static Op_ext.JRProxyOp JRget_op_blockRead_voidTovoid()
    {
        return op_blockRead_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_blockRead_voidTovoid;
    ;
    static    {
        try    {
            op_blockRead_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_blockRead_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static Op_ext.JRProxyOp JRget_op_blockWrite_voidTovoid()
    {
        return op_blockWrite_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_blockWrite_voidTovoid;
    ;
    static    {
        try    {
            op_blockWrite_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_blockWrite_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static Op_ext.JRProxyOp JRget_op_mutexReaders_voidTovoid()
    {
        return op_mutexReaders_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexReaders_voidTovoid;
    ;
    static    {
        try    {
            op_mutexReaders_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexReaders_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static Op_ext.JRProxyOp JRget_op_mutexWriters_voidTovoid()
    {
        return op_mutexWriters_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_mutexWriters_voidTovoid;
    ;
    static    {
        try    {
            op_mutexWriters_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_mutexWriters_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    {
        public ProcOp_intTovoid_impllector(PrioridadEscritor thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                PrioridadEscritor.lectorintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    PrioridadEscritor.lectorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop0: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexReaders_voidTovoid().recv();
                    ...
                    if (lectoresActivos == 1) {
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = JRget_op_blockRead_voidTovoid().recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                    }
                    JRget_op_mutexReaders_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    // Begin Expr2
                    ...
                    if (lectoresActivos == 0) {
                        JRget_op_blockRead_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    }
                    JRget_op_mutexReaders_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
    ...
    {
        public ProcOp_intTovoid_implescritor(PrioridadEscritor thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                PrioridadEscritor.escritorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    PrioridadEscritor.escritorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_mutexWriters_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    if (escritoresActivos == 1) {
                        ...
                        JRget_op_blockWrite_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    }
                    JRget_op_mutexWriters_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = JRget_op_blockWrite_voidTovoid().recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
    ...
    {
        public ProcOp_voidTovoid_impldone(PrioridadEscritor thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                PrioridadEscritor.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    PrioridadEscritor.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRPrioridadEscritor jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRPrioridadEscritor(op_done_voidTovoid, op_escritor_intTovoid, op_lector_intTovoid, op_mutexWriters_voidTovoid, op_mutexReaders_voidTovoid, op_blockWrite_voidTovoid, op_blockRead_voidTovoid);
    	this.JRcalled = true;
    }
