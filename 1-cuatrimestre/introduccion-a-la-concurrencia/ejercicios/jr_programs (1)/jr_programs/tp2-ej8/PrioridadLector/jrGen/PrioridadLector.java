...
public class PrioridadLector extends java.lang.Object {
    { JRinit(); }
    
    public PrioridadLector() {
        // Begin Expr2
        super();
        JRprocess();
    }
    private static Op_ext.JRProxyOp JRget_op_readWrite_voidTovoid()
    {
        return op_readWrite_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_readWrite_voidTovoid;
    ;
    static    {
        try    {
            op_readWrite_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 1;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_readWrite_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
    ...
    {
        public ProcOp_intTovoid_impllector(PrioridadLector thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                PrioridadLector.lectorintTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    PrioridadLector.lectorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop0: while (true) {
                    ...
                    if (lectoresActivos == 1) {
                        {
                            jrvm.sendAndDie();
                            Recv_ext recv_voidTovoid = JRget_op_readWrite_voidTovoid().recv();
                            jrvm.ariseAndReceive();
                            if (recv_voidTovoid.retOp != null)
                                recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                        }
                    ...
                    if (lectoresActivos == 0) {
                        JRget_op_readWrite_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    }
                    JRget_op_mutex_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
    ...
    {
        public ProcOp_intTovoid_implescritor(PrioridadLector thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                PrioridadLector.escritorintTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    PrioridadLector.escritorintTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    {
        public ProcOp_voidTovoid_impldone(PrioridadLector thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                PrioridadLector.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    PrioridadLector.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRPrioridadLector jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRPrioridadLector(op_done_voidTovoid, op_escritor_intTovoid, op_lector_intTovoid, op_mutex_voidTovoid, op_readWrite_voidTovoid);
    	this.JRcalled = true;
    }
