...
public class Filosofos extends java.lang.Object {
    { JRinit(); }
    ...
    static {
        ...
        JRLoop0: for (int i = 0; i < N; i++) {
            // Begin Expr2
            fork[i] = new Cap_ext_(new Op_ext_.JRProxyOp(InOp_ext_impl.create((tinit[i]))));
        }
    }
    ...
    {
        public ProcOp_intTovoid_implfilosofo(Filosofos thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                Filosofos.filosofointTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Filosofos.filosofointTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
        ...
        try    {
            ...
            int i = ((Number) JRargs[0]).intValue();
            {
                JRLoop1: while (true) {
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = fork[i + 1].recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    fork[i + 1].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
            }
        } catch (Exception JRe)    {
    ...
    private static Op_ext.JRProxyOp JRget_op_quintoFilosofo_voidTovoid()
    {
        return op_quintoFilosofo_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_quintoFilosofo_voidTovoid;
    static class ProcOp_voidTovoid_implquintoFilosofo extends ProcOp_ext_impl
    {
        public ProcOp_voidTovoid_implquintoFilosofo(Filosofos thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Filosofos.quintoFilosofovoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Filosofos.quintoFilosofovoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    static    {
        try    {
            op_quintoFilosofo_voidTovoid = new Op_ext_.JRProxyOp(new ProcOp_voidTovoid_implquintoFilosofo(null));
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    
    private static void quintoFilosofovoidTovoid(java.lang.Object [] JRargs) {
        ((Op_ext_.JRProxyOp)op_quintoFilosofo_voidTovoid).call(jrvm.getTimestamp(), JRargs);
    }
    private static void quintoFilosofovoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop2: while (true) {
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = fork[0].recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    ...
                    {
                        jrvm.sendAndDie();
                        Recv_ext recv_voidTovoid = fork[4].recv();
                        jrvm.ariseAndReceive();
                        if (recv_voidTovoid.retOp != null)
                            recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
                    }
                    // Begin Expr2
                    comer(4);
                    fork[0].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                    fork[4].send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
                }
            }
        } catch (Exception JRe)    {
            if (retOp != null && fretOp == null)
    ...
    static {
        try {
            op_quintoFilosofo_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
        } catch (Exception JRe) { throw new jrRuntimeError(JRe.toString()); }
    };
    ...
    {
        public ProcOp_voidTovoid_impldone(Filosofos thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                Filosofos.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    Filosofos.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRFilosofos jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRFilosofos(op_done_voidTovoid, op_quintoFilosofo_voidTovoid, op_filosofo_intTovoid);
    	this.JRcalled = true;
    }
