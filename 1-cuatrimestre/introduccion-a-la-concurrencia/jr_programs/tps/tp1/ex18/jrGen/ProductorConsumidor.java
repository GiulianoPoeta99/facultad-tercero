...
public class ProductorConsumidor extends java.lang.Object {
    { JRinit(); }
    ...
    {
        public ProcOp_voidTovoid_implproductor(ProductorConsumidor thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                ProductorConsumidor.productorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductorConsumidor.productorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
        ...
        try    {
            {
                int producto = 0;
                JRLoop1: while (true) {
                    JRLoop0: while (buffer.estaLlena()) {
                    }
                    // Begin Expr2
                    producto++;
    ...
    {
        public ProcOp_voidTovoid_implconsumidor(ProductorConsumidor thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProductorConsumidor.consumidorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductorConsumidor.consumidorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void consumidorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop3: while (true) {
                    JRLoop2: while (buffer.estaVacia()) {
                    }
    ...
    {
        public ProcOp_voidTovoid_impldone(ProductorConsumidor thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProductorConsumidor.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductorConsumidor.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRProductorConsumidor jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRProductorConsumidor(op_done_voidTovoid, op_consumidor_voidTovoid, op_productor_voidTovoid);
    	this.JRcalled = true;
    }
