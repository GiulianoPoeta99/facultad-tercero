...
public class ProductorConsumidor2 extends java.lang.Object {
    { JRinit(); }
    
    public ProductorConsumidor2() {
        // Begin Expr2
        super();
        JRprocess();
    }
    ...
    {
        public ProcOp_voidTovoid_implconsumidor(ProductorConsumidor2 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                ProductorConsumidor2.consumidorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductorConsumidor2.consumidorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    private static void consumidorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop4: while (consumido < MAX_PRODUCTOS) {
    ...
    {
        public ProcOp_voidTovoid_implproductor(ProductorConsumidor2 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProductorConsumidor2.productorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductorConsumidor2.productorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    private static void productorvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop5: while (producto < MAX_PRODUCTOS) {
                    // Begin Expr2
                    producto++;
    ...
    private static void donevoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                JRLoop6: while (!productorFin && !consumidorFin) {
                }
                // Begin Expr2
    ...
    {
        public ProcOp_voidTovoid_impldone(ProductorConsumidor2 thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                ProductorConsumidor2.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    ProductorConsumidor2.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected JRProductorConsumidor2 jrresref;
    public Object JRgetjrresref()
    { try {return jrresref.clone(); } catch (Exception e) {/* not gonna happen */ return null; } }
    protected void JRinit() {
    	if(this.JRcalled) return;
    	jrresref = new JRProductorConsumidor2(op_done_voidTovoid, op_productor_voidTovoid, op_consumidor_voidTovoid);
    	this.JRcalled = true;
    }
